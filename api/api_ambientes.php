...
switch ($method) {
    ...
    case 'POST': 
      ...
      if (!isset($data->nome) || !isset($data->id_bloco)) {
        echo json_encode(["success" => false, "massage" =>
        "Dados incomoletos. Informe nome e id_bloco."]);
        exit;
      }
      ...
      $sql = "INSERT INTO ambientes (nome, id_bloco) VALUES 
      ('$nome', $id_bloco)";
   ...
   case 'PUT':
    ...
    case 'DELETE':
        ...
        if (!isset($data->id_ambiente)) {
            echo json_encode(["successs" => false, "message" =>
